package com.furybase.customviews.circleviews
...
class FuryCircleImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet, defStyle: Int = 0) : super(context, attrs, defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.CircleImageView_civ_border_width_1, DEFAULT_BORDER_WIDTH)
        mBorderColor = a.getColor(R.styleable.CircleImageView_civ_border_color_1, DEFAULT_BORDER_COLOR)
        mBorderOverlay = a.getBoolean(R.styleable.CircleImageView_civ_border_overlay_1, DEFAULT_BORDER_OVERLAY)

        // Look for deprecated civ_fill_color if civ_circle_background_color is not set
        if (a.hasValue(R.styleable.CircleImageView_civ_circle_background_color_1)) {
            mCircleBackgroundColor = a.getColor(
                R.styleable.CircleImageView_civ_circle_background_color_1,
                DEFAULT_CIRCLE_BACKGROUND_COLOR
            )
        } else if (a.hasValue(R.styleable.CircleImageView_civ_fill_color_1)) {
            mCircleBackgroundColor = a.getColor(
                R.styleable.CircleImageView_civ_fill_color_1,
                DEFAULT_CIRCLE_BACKGROUND_COLOR
            )
        }
